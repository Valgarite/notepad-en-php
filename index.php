...
<body>
    <header style="background-color:blue; text-align: center; border-style: dotted; margin-left:0.2em; margin-right: 0.2em;">
        <h2>Editor de texto en PHP</h2>
    </header>
    <?php
    ...
    <div class="container" id="editor_container">
        <header style="background-color:blue; text-align: center; border-style: dotted;"><h2>Archivo</h2></header>
        <form name="text_save" method="post" target="_self" id="text">
            <table border="1">
                <tr>
            <td><label for="file_name">Nombre del archivo:</label></td>
            <td><input type="text" name="file_name" id="file_name" value="<?php
                include_once('./assets/php/cargar_nombre.php');
            ?>" size=40></td>
            </tr>
            
            <table border="1">
                <tr><th colspan="2">Contenido</th></tr>
                ...
                <tr>
                    <td><h5>Todos los archivos se guardan con la extensión .txt</h5>
                    <td>
    ...
    <div class="container" id="folder_container">
        <header style="background-color:blue; text-align: center; border-style: dotted;">
            <h2>Directorios</h2>
        </header>
...
directorio principal"/>
                ...
                <tr><th colspan=6>Archivos del directorio actual:</th></tr>
        </form>
        <div>
            <?php
